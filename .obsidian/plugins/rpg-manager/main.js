...
// src/linkSuggester/handlers/pixelFinder.js
var require_pixelFinder = __commonJS({
  "src/linkSuggester/handlers/pixelFinder.js"(exports, module2) {
    (function() {
      var properties = [
        "direction",
        "boxSizing",
...
var sceneTypeDescription = /* @__PURE__ */ new Map([
  ...
  [2 /* Encounter */, "Encounter: An NPC in involved (active)"],
...
var AbstractSubModelView = class extends AbstractRpgManager {
  ...
  addEditorIcon(cellEl, currentComponent, identifier) {
    this._createEditorButton(cellEl).addEventListener("click", () => {
      this.factories.editableContent.open(currentComponent, identifier).then((opened) => {
        if (!opened)
  ...
  addRelationshipEditorIcon(cellEl, currentComponent, identifier) {
    this._createEditorButton(cellEl).addEventListener("click", () => {
      this.factories.editableContent.open(currentComponent, identifier).then((modalOpened) => {
        if (!modalOpened)
...
// src/linkSuggester/textAnalysers/LinkSuggesterTextAnalyser.ts
...
// src/search/FuzzyFileSearch.ts
var import_obsidian20 = require("obsidian");
var FuzzyFileSearch = class {
  constructor(_app) {
    this._app = _app;
  }
  search(term) {
    const response = [];
    const query = (0, import_obsidian20.prepareQuery)(term);
    const matches = /* @__PURE__ */ new Map();
    ...
    files.forEach((file) => {
      ...
      if (metadata !== void 0 && ((_a = metadata == null ? void 0 : metadata.frontmatter) == null ? void 0 : _a.alias) !== void 0 && metadata.frontmatter.alias.length > 0) {
        metadata.frontmatter.alias.forEach((alias) => {
          const fuzzySearchResult2 = (0, import_obsidian20.fuzzySearch)(query, alias);
          if (fuzzySearchResult2 != null && fuzzySearchResult2.matches != null && fuzzySearchResult2.score < 0) {
            matches.set(file.path + alias, {
              title: alias,
              file,
              alias,
              fancyTitle: this._setFancyName(alias, fuzzySearchResult2, true),
              fancySubtitle: this._setFancyName(file.path, (0, import_obsidian20.fuzzySearch)(query, file.path), false),
              resultScoring: fuzzySearchResult2
            });
          }
        });
      }
      const fuzzySearchResult = (0, import_obsidian20.fuzzySearch)(query, file.basename);
  ...
  _setFancyName(text, fuzzySearchResult, isTitle = true) {
...
// src/linkSuggester/popUps/LinkSuggesterPopUp.ts
var import_obsidian21 = require("obsidian");

// src/linkSuggester/eventListeners/LinkSuggesterKeyboardEventListener.ts
var LinkSuggesterKeyboardEventListener = class {
  constructor(_app, _handler) {
    this._app = _app;
  ...
  fill(results, top, left) {
    ...
    this._results.forEach((searchResult, index) => {
      ...
      if (searchResult.alias !== void 0) {
        ...
        (0, import_obsidian21.setIcon)(suggestionFlairEl, "corner-up-right");
      }
    });
...
// src/linkSuggester/handlers/LinkSuggesterHandler.ts
var LinkSuggesterHandler = class {
  constructor(_app, _containerEl) {
    this._app = _app;
...
// src/analyser/views/AnalyserVisualView.ts
...
var AnalyserVisualView = class extends AbstractAnalyserView {
  ...
  addCircle(containerEl, percentage, threshold, isHigerBetter, description) {
    ...
    import_obsidian22.MarkdownRenderer.renderMarkdown(description, circleDescriptionEl, "", null);
    if (isHigerBetter) {
...
// src/analyser/views/AnalyserSceneBuilderView.ts
...
// src/sceneBuilder/modals/SceneBuilderModal.ts
var SceneBuilderModal = class extends AbstractModal {
  constructor(app2, _act) {
    super(app2);
    this._act = _act;
  ...
  onOpen() {
    ...
    const sceneBuilderContainerEl = this.rpgmContainerEl.createDiv({ cls: "rpgm-scene-builder" });
    ...
    const buttonContainerEl = sceneBuilderContainerEl.createDiv({ cls: "rpgm-scene-builder-confirmation-button" });
  ...
  _createScenes() {
    return __async(this, null, function* () {
      let sceneId = 1;
      const scenes = this.database.readList(8 /* Scene */, this._act.id);
      ...
      for (let index = 0; index < this._scenesContainerEl.rows.length; index++) {
        ...
        const title = "a" + this._act.id.id + "s" + sceneId.toString() + " - " + line.cells[0].childNodes[0].value;
        this.factories.files.silentCreate(8 /* Scene */, title, this._act.id.campaignId, this._act.id.adventureId, this._act.id.actId, sceneId, void 0, {
          synopsis: line.cells[1].childNodes[0].value,
          sceneType: sceneType !== void 0 ? this.factories.sceneType.createReadableSceneType(sceneType) : "",
  ...
  _refreshAnalyser() {
    return __async(this, null, function* () {
      ...
      for (let index = 0; index < this._scenesContainerEl.rows.length; index++) {
        ...
        if (type !== "") {
          const sceneType = this.factories.sceneType.createSceneType(type);
          data.push({
            isExciting: cells[3].childNodes[0].checked,
            isActive: sceneType !== void 0 ? (_a = activeSceneTypes.get(sceneType)) != null ? _a : false : false,
            expectedDuration: sceneType !== void 0 ? this.factories.runningTimeManager.getTypeExpectedDuration(this._act.id.campaignId, sceneType) : 0,
            type: sceneType
          });
        }
      }
...
var CampaignHeaderView = class extends AbstractPlotHeaderView {
  ...
  _addCurrentComponentSelector(contentEl, type, currentComponent, components) {
    ...
    return (contentEl2, type2, currentComponent2, components2) => {
      ...
      if (link !== void 0) {
        import_obsidian23.MarkdownRenderer.renderMarkdown(link, contentEl2, "", null);
      } else {
...
var SceneTypeDescriptionModal = class extends AbstractRpgManagerModal {
  ...
  _displaySceneTypeInformation(sceneTypeInformation) {
    ...
    import_obsidian24.MarkdownRenderer.renderMarkdown(sceneTypeInformation.description, descriptionEl, "", null);
  }
  onClose() {
    super.onClose();
  }
    ...
    if (sceneId !== void 0) {
      ...
      sessions.forEach((session) => {
        ...
        if (data.value.content.toString() === ((_a2 = session.id.sessionId) == null ? void 0 : _a2.toString())) {
          import_obsidian25.MarkdownRenderer.renderMarkdown(session.file.path, contentEl, "", null);
        }
      });
    }
  }
      ...
      if (sceneId2 !== void 0) {
        ...
        sessions.forEach((session) => {
          ...
          if (data2.value.content !== void 0 && data2.value.content.toString() === ((_a3 = session.id.sessionId) == null ? void 0 : _a3.toString())) {
            import_obsidian25.MarkdownRenderer.renderMarkdown(session.link, contentEl2, "", null);
          }
        });
      }
    };
    ...
    return __async(this, null, function* () {
      this._scenesEls.forEach((sceneEl, path2) => {
        ...
        if (initialSceneCheked === void 0 || sceneEl.checked !== initialSceneCheked) {
          ...
          if (file != null && file instanceof import_obsidian26.TFile) {
...
var SessionHeaderView = class extends AbstractPlotHeaderView {
  render(container, data) {
    ...
    if (this._analyser !== void 0) {
      this._analyser.render(1 /* Visual */, this.headerContainerEl);
      this._analyser.render(0 /* Extended */, this.headerContainerEl);
    }
  }
...
var RunningTimeManager = class extends AbstractRpgManager {
  ...
  getTypeExpectedDuration(campaignId, type) {
    var _a, _b;
    const previousDurations = (_b = (_a = this.factories.runningTimeManager.medianTimes.get(campaignId)) == null ? void 0 : _a.get(type)) != null ? _b : [];
...
var AbstractRpgManagerComponent = class extends import_obsidian27.Component {
  constructor(app2) {
    super();
    this.app = app2;
  }
      ...
      if (oldBaseName !== void 0 && component !== void 0 && metadata != null) {
        ...
        DatabaseInitialiser.reinitialiseRelationships(component, this).then(() => {
          ...
          if (((_a = this.app.workspace.getActiveFile()) == null ? void 0 : _a.path) === file.path) {
            (_b = this.app.workspace.getActiveViewOfType(import_obsidian28.MarkdownView)) == null ? void 0 : _b.editor.refresh();
          }
          this.app.workspace.trigger("rpgmanager:refresh-views");
        });
      }
      ...
      if (section !== void 0) {
        if (section.type === "code") {
          if (arrayContent[section.position.start.line] === "```RpgManagerData") {
            ...
            if (codeBlockContent !== "") {
              if (!requestString)
                return (0, import_obsidian29.parseYaml)(codeBlockContent);
...
var GalleryListModalView = class extends AbstractGalleryModalView {
  render(containerEl) {
    ...
    this.component.images.forEach((image) => {
      ...
      if (image.caption !== "") {
        import_obsidian30.MarkdownRenderer.renderMarkdown(image.caption, imageCaptionEl, "", null);
      }
...
var GalleryUploadModalView = class extends AbstractConfirmationGalleryModalView {
  render(containerEl) {
    ...
    (0, import_obsidian31.setIcon)(this._dropZoneEl, "download");
...
// src/services/contentEditor/enums/EditableContentType.ts
...
// src/services/contentEditor/abstracts/AbstractEditorModal.ts
var AbstractEditorModal = class extends AbstractModal {
  constructor(app2, component, editableContentType, editableField, isLongText) {
    super(app2);
    this.component = component;
  ...
  saveContent() {
    return __async(this, null, function* () {
      ...
      this.manipulators.codeblock.update(this.editableField, value);
      this.close();
    });
  }
};

// src/services/contentEditor/modals/ContentEditorModal.ts
var ContentEditorModal = class extends AbstractEditorModal {
  constructor(app2, component, editableContentType, editableField, isLongText) {
    super(app2, component, editableContentType, editableField, isLongText);
    let title = "";
...
// src/services/contentEditor/modals/StoryCircleContentEditorModal.ts
var import_obsidian32 = require("obsidian");
var StoryCircleContentEditorModal = class extends AbstractEditorModal {
  constructor(app2, component, editableContentType, editableField, _relatedAbtValue) {
    super(app2, component, editableContentType, editableField, true);
  ...
  onOpen() {
    ...
    if (this._relatedAbtValue !== "") {
      ...
      const alternativeTextContainerEl = this.contentEditorContainerEl.createDiv({ cls: "rpgm-content-editor-abt-relative" });
      ...
      import_obsidian32.MarkdownRenderer.renderMarkdown(this._relatedAbtValue, alternativeTextEl, "", null);
...
// src/services/contentEditor/modals/RelationshipEditorModal.ts
var RelationshipEditorModal = class extends AbstractEditorModal {
  constructor(app2, component, editableField, _relationship) {
    var _a, _b, _c;
    super(app2, component, void 0, editableField, true);
  ...
  saveContent() {
    return __async(this, null, function* () {
      ...
      this.manipulators.codeblock.addOrUpdateRelationship(this._relationship);
      this.close();
    });
  }
};

// src/services/contentEditor/factories/EditableContentFactory.ts
var EditableContentFactory = class extends AbstractFactory {
  open(component, editableField) {
    return __async(this, null, function* () {
      const type = yield this.factories.editableContentField.create(editableField);
      switch (type) {
        case 0 /* Synopsis */:
        case 1 /* Goals */:
        case 3 /* Action */:
        ...
        case 17 /* StoryCircleChange */:
          ...
          break;
        default:
          const relatedComponent = component.getRelationships().filter((relationship) => relationship.path === editableField);
...
// src/services/contentEditor/factories/EditableContentTypeFactory.ts
var EditableContentTypeFactory = class extends AbstractFactory {
...
// src/services/contentEditor/factories/EditableContentValueFactory.ts
var EditableContentValueFactory = class extends AbstractFactory {
  read(component, type) {
    let response = void 0;
    switch (type) {
      case 0 /* Synopsis */:
  ...
  readRelatedPlot(component, type) {
    var _a, _b, _c, _d;
    switch (type) {
      case 10 /* StoryCircleYou */:
      case 11 /* StoryCircleNeed */:
...
var CreationModal = class extends AbstractRpgManagerModal {
  ...
  onOpen() {
    ...
    contentEl.empty();
    contentEl.addClass("rpgm-modal");
    if (!this._create && this.app.workspace.getActiveViewOfType(import_obsidian33.MarkdownView) == null) {
...
var SettingsFactory = class {
  ...
  createTextSetting(type, description = "") {
    ...
    return new import_obsidian34.Setting(this._containerEl).setName(settings.title).setDesc(this._generateFragment(description)).addText((text) => {
      var _a;
  ...
  createDropdownSetting(type, description, options) {
    ...
    if (settings === void 0)
      throw new Error("Setting type not found");
    return new import_obsidian34.Setting(this._containerEl).setName(settings.title).setDesc(this._generateFragment(description)).addDropdown((dropdown) => {
      dropdown.addOption("", "");
  ...
  createToggleSetting(type, description) {
    ...
    if (settings === void 0)
      throw new Error("Setting type not found");
    return new import_obsidian34.Setting(this._containerEl).setName(settings.title).setDesc(this._generateFragment(description)).addToggle((toggle) => toggle.setValue(settings.value).onChange((value) => __async(this, null, function* () {
      switch (type) {
...
// src/settings/RpgManagerSettings.ts
var RpgManagerSettings = class extends import_obsidian35.PluginSettingTab {
  constructor(app2) {
  ...
  _createFolderMap(parent = void 0, indent = 0) {
    let folderList = [];
    if (parent != void 0) {
      folderList = parent.children.filter((file) => file instanceof import_obsidian35.TFolder);
    } else {
      this._folderMap = /* @__PURE__ */ new Map();
      folderList = this.app.vault.getRoot().children.filter((file) => file instanceof import_obsidian35.TFolder);
    }
...
// src/abstracts/AbstractRpgManagerView.ts
var AbstractRpgManagerView = class extends import_obsidian36.ItemView {
...
var ErrorView = class extends AbstractRpgManagerView {
    ...
    return __async(this, null, function* () {
      if (this._errors !== void 0 && this._errors.size > 0) {
        this._errors.forEach((error, file) => {
          ...
          import_obsidian37.MarkdownRenderer.renderMarkdown(error.showErrorActions(), errorDescriptionEl, file.path, null);
  ...
  _addLink(contentEl, linkOrFile) {
    let file;
    if (linkOrFile instanceof import_obsidian37.TFile) {
      file = linkOrFile;
      ...
      if (!wasAlreadyUpdated) {
        ...
        for (let index = 0; index < campaigns.length; index++) {
          ...
          yield file.parent.children.forEach((fileOrFolder) => {
            if (fileOrFolder instanceof import_obsidian38.TFolder && fileOrFolder.name === "Sessions") {
...
var V2_0_to_3_0_worker = class extends AbstractDatabaseWorker {
          ...
          if (codeblock !== void 0 && codeblock.type === "yaml" && index === 0) {
            ...
            if (firstCodeblockStartLine === void 0) {
              ...
              if (firstCodeblockStartLine != void 0 && firstCodeblockEndLine != void 0) {
                ...
                firstCodeblockMetadata = (0, import_obsidian39.parseYaml)(firstCodeblockMetadataContent);
              }
            } else {
  ...
  _cleanFrontmatter(frontmatterMetadataContentArray) {
    ...
    const frontmatter = (0, import_obsidian39.parseYaml)(frontmatterContent);
  ...
  run(reporter = void 0) {
    return __async(this, null, function* () {
      ...
      for (let filesIndex = 0; filesIndex < files.length; filesIndex++) {
        ...
        const yaml = (0, import_obsidian40.parseYaml)(data.join("\n"));
        if (yaml == void 0) {
          if (reporter !== void 0)
            reporter.addFileUpdated();
          continue;
  ...
  render() {
    return __async(this, null, function* () {
      ...
      if (releaseNotes != null) {
        import_obsidian41.MarkdownRenderer.renderMarkdown(releaseNotes, this.rpgmContentEl, "", null);
      }
...
var RPGManagerView = class extends AbstractRpgManagerView {
  ...
  _addIncompleteComponents() {
    return __async(this, null, function* () {
      ...
      arrowEl.style.marginRight = "10px";
      (0, import_obsidian42.setIcon)(arrowEl, "openClose");
  ...
  render() {
    return __async(this, null, function* () {
      ...
      this._elements.forEach((timeline) => {
        ...
        if (file !== null && file instanceof import_obsidian43.TFile) {
          titleEl.createEl("a", { text: file.basename, href: "#" }).addEventListener("click", () => {
            this.app.workspace.getLeaf(false).openFile(file);
          });
        }
        const descriptionEl = contentEl.createDiv();
        import_obsidian43.MarkdownRenderer.renderMarkdown(timeline.synopsis, descriptionEl, "", null);
      ...
      if (activeView != null) {
        ...
        for (let index = 0; index < ((_b = (_a = cache == null ? void 0 : cache.sections) == null ? void 0 : _a.length) != null ? _b : 0); index++) {
          ...
          if (stringYaml !== void 0 && editor.getLine(stringYaml.position.start.line) === "```RpgManagerData") {
            ...
            const yaml = (_c = (0, import_obsidian44.parseYaml)(range)) != null ? _c : {};
        ...
        if (section !== void 0) {
          if (section.type === "code") {
            if (arrayContent[section.position.start.line] === "```RpgManagerData") {
              ...
              try {
                const newCodeBlockContent = (0, import_obsidian44.parseYaml)(codeBlockContent);
                if (codeBlockContent !== "")
...
var UpdaterModal = class extends AbstractRpgManagerModal {
  ...
  _updateModalDescription(content, addCounters = void 0) {
    return __async(this, null, function* () {
      this._infoEl.empty();
      import_obsidian45.MarkdownRenderer.renderMarkdown(content, this._infoEl, "", null);
      if (addCounters) {
        ...
        this.app.workspace.on("active-leaf-change", (leaf) => {
          if (this.factories.runningTimeManager.isTimerRunning) {
            ...
            this.app.workspace.iterateAllLeaves((leaf2) => {
              var _a;
              if (leaf2.view instanceof import_obsidian46.MarkdownView) {
